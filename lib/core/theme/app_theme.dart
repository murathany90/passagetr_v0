...
class AppTheme {
  ...
  static ThemeData dark() {
    const ColorScheme colorScheme = ColorScheme(
      ...
      primary: Color(0xFF7FD9B8),
      onPrimary: Color(0xFF003826),
      primaryContainer: Color(0xFF0F5D44),
      onPrimaryContainer: Color(0xFFCAF2E2),
      secondary: Color(0xFFB0D2C7),
      onSecondary: Color(0xFF19352C),
      secondaryContainer: Color(0xFF29493F),
      onSecondaryContainer: Color(0xFFCCEFE3),
      ...
      outline: Color(0xFF8EA59C),
      outlineVariant: AppColors.darkSurfaceVariant,
      shadow: Color(0x66000000),
      scrim: Color(0x66000000),
      inverseSurface: Color(0xFFE3EEE8),
      onInverseSurface: Color(0xFF1B211E),
      inversePrimary: AppColors.primary,
      surfaceTint: Color(0xFF7FD9B8),
    );
